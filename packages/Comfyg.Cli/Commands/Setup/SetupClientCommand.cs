...
internal class SetupClientCommand : Command
{
    ...
    public SetupClientCommand() : base("client", "Registers a new client on the connected Comfyg store.")
    {
        ...
        _keysOption = new Option<FileInfo?>(new[] {"-k", "--keys"},
            "Path to a RFC 7468 PEM-encoded file which contains the public key portion of the client secret and the private key portion for encryption. If not provided, a symmetric client secret will be generated by the Comfyg store and no encryption will be applied.");
